  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E7E9E5] via-[#B7C5C7] to-[#E7E9E5]">
      <main className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-10 max-w-[1400px] mx-auto">
        ...
        <motion.div 
          className="mt-6 mb-8 bg-gradient-to-br from-white via-[#E7E9E5] to-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-end">
              ...
              <div className="lg:col-span-5 relative">
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <div className="absolute z-20 left-0 right-0 mt-2 bg-gradient-to-br from-white via-[#E7E9E5] to-white border-2 border-gray-100 rounded-xl shadow-xl max-h-64 overflow-y-auto">
                    {suggestionLoading && (
              ...
              <div className="lg:col-span-2 flex flex-col sm:flex-row gap-2 w-full">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-br from-white to-[#E7E9E5] text-gray-600 px-4 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg border-2 border-gray-200 hover:border-gray-300 hover:from-[#E7E9E5] hover:to-[#B7C5C7] transition-all duration-200 flex items-center justify-center gap-2 text-sm min-w-0"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
