...
import {
  ...
  Box, IconButton, Chip, CircularProgress
} from '@mui/material';
import {
...
const RoomInquiriesTab = ({ roomInquiries, inquiriesLoading, onInquiryAction }) => {
  return (
    <Box sx={{ mt: 3 }}>
      {inquiriesLoading ? (
                      ...
                      <Box sx={{ display: 'flex', gap: 1 }}>
                        {inquiry.status === 'pending' && (
                          <>
                            <IconButton
                              color="success"
                              onClick={() => onInquiryAction(inquiry._id, 'confirmed')}
                            ...
                            <IconButton
                              color="error"
                              onClick={() => onInquiryAction(inquiry._id, 'cancelled')}
