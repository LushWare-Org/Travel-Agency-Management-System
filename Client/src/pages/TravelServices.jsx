    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3">
          <div
            id="hero-dot-0"
            className="w-3 h-3 bg-white rounded-full scale-125 transition-all duration-300"
          ></div>
          <div
            id="hero-dot-1"
            className="w-3 h-3 bg-white/50 rounded-full transition-all duration-300"
          ></div>
          <div
            id="hero-dot-2"
            className="w-3 h-3 bg-white/50 rounded-full transition-all duration-300"
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6 animate-fade-in-left animate-delay-3">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@fasmala.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Malé, Maldives</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-fade-in-right animate-delay-2">
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-3xl p-8 text-white shadow-2xl animate-float">
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50"
                  ></textarea>
                  <button className="w-full bg-white text-blue-600 font-bold py-3 px-6 rounded-xl hover:bg-gray-50 transition-colors">
                    Send Message
                  </button>
                </div>
              </div>
