    ...
    <footer className="bg-gray-900 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <p className="text-blue-200 ml-[6px]"> 
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-white-300">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-white-300">Contact Us</h3>
